...
const FinalCTA = ({ whatsapp }: FinalCTAProps) => (
  <section id="cta" className="py-32 relative z-10">
    <div className="container mx-auto px-6">
      <div className="relative max-w-3xl mx-auto text-center p-16 md:p-20 rounded-3xl glass-card overflow-hidden !hover:transform-none gradient-border">
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 0%, hsl(158 82% 50% / 0.1), transparent 70%)' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] pointer-events-none opacity-[0.04] morph-blob"
        ...
        <ScrollReveal delay={150}>
          <div className="flex flex-col sm:flex-row gap-3 justify-center relative z-10 mb-8">
            ...
            <a
              href={`https://wa.me/${whatsapp}?text=Hi%2C%20I'd%20like%20to%20set%20up%20NEXA%20StoreOS%20for%20my%20business.`}
              target="_blank"
