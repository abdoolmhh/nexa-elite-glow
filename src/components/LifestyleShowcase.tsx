...
const LifestyleShowcase = () => (
  <section className="py-32 relative z-10 overflow-hidden" style={{ background: 'hsl(var(--secondary) / 0.3)' }}>
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] pointer-events-none opacity-[0.05] morph-blob"
        ...
        <ScrollReveal>
          <div className="relative perspective-container">
            <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
              <div className="w-3/4 h-3/4 rounded-full blur-[100px] morph-blob" style={{ background: 'hsl(158 82% 50% / 0.12)' }} />
            </div>

            <div className="relative float-gentle" style={{ transform: 'perspective(800px) rotateY(4deg) rotateX(-2deg)' }}>
              <img
                src={lifestyleLady}
                alt="Business owner managing store with NEXA on mobile"
              ...
              <div className="absolute -bottom-5 -right-5 glass-card !p-3 float-slow hidden md:block max-w-[200px] !hover:transform-none">
                <img src={mockupAnalytics} alt="Real-time analytics" className="w-full rounded-lg" loading="lazy" />
              </div>
              ...
              <div className="absolute top-4 -left-3 glass-card !p-3 float-delayed hidden md:block !hover:transform-none">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-foreground">₦12,400 sale</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <ScrollReveal delay={150}>
          <div className="max-w-md">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed text-lg">
              Check sales anywhere. Get AI alerts while you sleep. No desk required.
            </p>

            <div className="space-y-4 mb-10">
              {['Real-time sales anywhere', 'Instant low-stock alerts', 'Profit reports on the go'].map((item) => (
            ...
            <Link to="/try" className="btn-primary cta-glow inline-flex group">
              Try It Free
